      ...
      <div className="w-full max-w-4xl overflow-hidden rounded-3xl bg-white/90 shadow-2xl backdrop-blur-md md:flex">
        ...
        <section className="hidden w-1/2 flex-col justify-between bg-black/5 p-12 md:flex">
          ...
          <div className="relative">
            <div className="absolute -left-4 -top-4 h-24 w-24 rounded-full bg-cyan-400/20 blur-2xl" />
            <div className="absolute -bottom-4 -right-4 h-32 w-32 rounded-full bg-pink-400/20 blur-2xl" />
            <div className="relative rounded-2xl border border-white/50 bg-white/40 p-6 shadow-sm backdrop-blur-sm">
              <p className="text-sm italic text-slate-700">
                "Easy to use, great content, and helpful community. Highly recommended!"
              </p>
              <p className="mt-2 text-xs font-bold text-slate-900">— Michael R., DevOps Lead</p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full p-8 md:w-1/2 md:p-12">
          <div className="mx-auto max-w-sm">
            ...
            <p className="mt-2 text-sm text-slate-500">Get started with your free account.</p>
